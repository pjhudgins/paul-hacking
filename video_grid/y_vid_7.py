...
class BabyVideoApp(QWidget):
    def __init__(self):
        ...
        self.button_texts = ["Video 1", "Video 2", "Video 3", "Video 4"]
        self.playback_time_ms = 10000  # Playback duration in milliseconds
        self.button_styles = "font-size: 24px; height: 100%; width: 100%; background-color: lightblue;"
        ...
        for i in range(len(self.video_paths)):
            button = QPushButton(self.button_texts[i])
